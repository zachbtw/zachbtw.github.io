...
![](websiteassets/CapstoneAssets/Slides_Assets/DJ_MOORE_TIES_THE_GAME.gif){width="800"}
:::
...
::: {.column width="50%"}
![](websiteassets/CapstoneAssets/Slides_Assets/highWP.gif)
:::
:::::::::
...
::: {style="text-align: center;"}
![](websiteassets/CapstoneAssets/Slides_Assets/dadamsthrow.gif)
:::
...
::::: columns
::: {.column width="50%"}
<br> ![](websiteassets/CapstoneAssets/Slides_Assets/speedVect.png)
:::

::: {.column width="50%"}
![](websiteassets/CapstoneAssets/Slides_Assets/corr_plot.png)
:::
:::::

## Deriving QB Line of Sight Prior to Throw

![](websiteassets/CapstoneAssets/Slides_Assets/vision_example.gif)
...
::::: columns
::: {.column width="66%"}
![](websiteassets/CapstoneAssets/Slides_Assets/PJMoorePredictions.png)
:::

::: {.column width="34%"}
<br><br> ![](websiteassets/CapstoneAssets/Slides_Assets/moore_throw_rankings.png)
:::
:::::
...
::::: columns
::: {.column width="50%"}
<br>![](websiteassets/CapstoneAssets/Slides_Assets/MostPredictable.png)
:::

::: {.column width="50%"}
<br> ![](websiteassets/CapstoneAssets/Slides_Assets/MostUnPredictable.png)
:::
:::::
...
::: {style="text-align: center;"}
![](websiteassets/CapstoneAssets/Slides_Assets/QBClustering_nt.png)
:::
...
![](websiteassets/CapstoneAssets/Slides_Assets/project_fail.png){style="max-height: 80vh;"}
:::
</div>
...
::: {style="text-align: center; width: 100%;"}
![](websiteassets/CapstoneAssets/Slides_Assets/vip_plot.png){style="max-height: 70vh;"}
:::
...
::: {style="text-align: center; width: 100%;"}
![](websiteassets/CapstoneAssets/Slides_Assets/Los_wr.png){style="max-height: 70vh;"}
:::
...
::: {style="text-align: center;"}
![](websiteassets/CapstoneAssets/Slides_Assets/Angle_diff_Histogram.png){width="656"}
:::

## Appendix E - Head Tracking Proof of Concept

::: {style="text-align: center;"}
![](websiteassets/CapstoneAssets/Slides_Assets/lionsplay.gif) ![](websiteassets/CapstoneAssets/Slides_Assets/washingtonpass.gif)
:::
